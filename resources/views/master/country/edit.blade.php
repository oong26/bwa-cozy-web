                    ...
                    <form action="{{route('country.update', $country->id)}}" method="post">       
                        ...
                        <div class="py-2">
                            <div class="col-span-6 sm:col-span-4">
                                <x-jet-label for="country" class="title-font-size" value="{{ __('Country') }}" />
                                <x-jet-input name="country" id="country" type="text" class="mt-3 block w-full" value="{{ old('country', $country->name) }}" autocomplete="country" placeholder="Enter a new country" />
                                @error('country')
